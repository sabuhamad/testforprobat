...
// Variant V5 (current version on disk)
      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            <h4 className="footer-subtitle">Product</h4>
            <ul className="footer-links">
              <li><a href="#" className="footer-link">Explore Features</a></li>
              <li><a href="#" className="footer-link">View Pricing</a></li>
              <li><a href="#" className="footer-link">Read Docs</a></li>
              <li><a href="#" className="footer-link">API</a></li>
            </ul>
          </div>
...
const Footer: React.FC = () => {
  return (
    <Experiment
      id="exp_Footer_20260317_7b3f9a2e"
      control={<FooterControl />}
      variants={{ V5: <FooterVariant /> }}
    />
  )
}
